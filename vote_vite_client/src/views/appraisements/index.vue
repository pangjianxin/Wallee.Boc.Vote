<template>
  <div class="m-5px">
    ...
    <van-list v-model:loading="loading" :finished="finished" finished-text="没有更多了" :offset="0" class="h-100%"
      @load="onLoad">
      <div v-for="item in cachedList" :key="item.id" class="flex flex-col mt-5px px-5px py-10px shadow-sm shadow-warmgray b-rd-5px bg-gradient-linear shape-[100deg] bg-gradient-from-purple bg-gradient-via-orange bg-gradient-to-rose
