<template>
  <div class="m-10px">
    ...
    <van-form label-width="60" label-align="left" ref="formRef" @submit="submit">
      <van-cell-group inset>
        <van-field label="内容名称" v-model="(form.name as string)" name="name" left-icon="records" placeholder="评估内容名称"
          :rules="formRules.name">
        </van-field>

        <van-field label="内容类别" left-icon="description" name="category">
          <template #input>
        ...
        <van-field label="内容描述" v-model="(form.description as string)" type="textarea" autosize name="description"
